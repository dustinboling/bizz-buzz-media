        ...
        >
          ...
          <div class="inline-flex">
            ...
            <a class="mr-3" href="https://www.facebook.com/bizzbuzznetwork" target="_blank">
              <svg
                class="h-5 svg-inline--fa fa-facebook-square fa-w-14"
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
            ...
            <a class="mr-3" href="http://www.instagram.com/bizzbuzznetwork" target="_blank">
              <svg
                class="h-5 svg-inline--fa fa-instagram fa-w-14"
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="instagram"
            ...
            <a href="https://www.twitter.com/bizzbuzznetwork" target="_blank">
              <svg
                class="h-5 svg-inline--fa fa-twitter-square fa-w-14"
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
